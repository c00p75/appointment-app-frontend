      ...
      >
        <div className="flex-column">
          ...
          <div className="input-form">
            ...
            <input placeholder="Enter your Email" className="input" type="email" name="email" />
          </div>
        </div>
        ...
        <div className="flex-column">
          ...
          <div className="input-form">
            ...
            <input placeholder="Enter your Password" className="input" type="password" name="password" />
          </div>
        </div>

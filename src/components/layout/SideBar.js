...
function SideBar({ showNav, setShowNav }) {
  ...
  return (
    <>
      <div>
        <button type="button" onClick={() => setShowNav(!showNav)} className="toggle-side-bar toggle-open-side-bar">
          ...
          <h1 className="logo">CycleCruise</h1>
        </button>
      ...
      <div className="app-navigation flex-center align-items-start flex-column">
        <span
          role="button"
          tabIndex={0}
          onClick={() => { navigate('/motorcycles'); closeMenu(); }}
          onKeyDown={(e) => { if (e.key === 'Enter') { navigate('/motorcycles'); closeMenu(); } }}
        ...
        <span
          role="button"
          tabIndex={0}
          onClick={() => { navigate('/reservations'); closeMenu(); }}
          onKeyDown={(e) => { if (e.key === 'Enter') { navigate('/reservations'); closeMenu(); } }}
        ...
        <span
          role="button"
          tabIndex={0}
          onClick={() => { handleUnauthorizedClick('/motorcycles/new'); closeMenu(); }}
          onKeyDown={(e) => { if (e.key === 'Enter') { handleUnauthorizedClick('/motorcycles/new'); closeMenu(); } }}
        ...
        <span
          role="button"
          tabIndex={0}
          onClick={() => { handleUnauthorizedClick('/motorcycles/delete'); closeMenu(); }}
          onKeyDown={(e) => { if (e.key === 'Enter') { handleUnauthorizedClick('/motorcycles/delete'); closeMenu(); } }}
        ...
        <span
          role="button"
          tabIndex={0}
          onClick={() => { handleUnauthorizedClick('/reservations/new'); closeMenu(); }}
          onKeyDown={(e) => { if (e.key === 'Enter') { handleUnauthorizedClick('/reservations/new'); closeMenu(); } }}
